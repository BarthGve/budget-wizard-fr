...
export const AddContributorDialog = ({ onAdd }: AddContributorDialogProps) => {
  ...
  // Contenu du formulaire commun aux deux types de dialogue
    ...
    return (
      <Sheet open={open} onOpenChange={(isOpen) => {
        ...
        <SheetContent 
          side="bottom"
          className={cn(
            "px-0 py-0 rounded-t-xl h-[90vh] overflow-hidden",
            "border-t shadow-lg",
            colors.borderLight,
            colors.borderDark
          )}
        >
          ...
          <div className="h-full overflow-y-auto pb-safe pt-4 px-0">
