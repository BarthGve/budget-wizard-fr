    ...
    >
      <div className="flex items-center justify-between mb-4">
        <h2 className={cn(
          ...
          "bg-gradient-to-r from-purple-600 via-purple-500 to-primary-500 bg-clip-text text-transparent",
          "dark:from-purple-400 dark:via-purple-400 dark:to-primary-400"
        )}>
          <div className={cn(
            "p-1 rounded",
