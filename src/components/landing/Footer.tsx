...
export const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-t from-background/80 to-transparent pt-16 pb-8 px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Simplifiez votre budget et atteignez vos objectifs financiers avec notre solution intuitive.
            </p>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  key={index}
                  href={social.href}
                  className="text-muted-foreground hover:text-primary rounded-full p-2 bg-gray-100 dark:bg-gray-800"
