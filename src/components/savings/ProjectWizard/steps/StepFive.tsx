...
import { CreditCard, DollarSign, Landmark, ReceiptText } from "lucide-react";
        ...
        {data.added_to_recurring && (
          ...
          >
            <div className={cn(
              ...
              {/* Note */}
              <div className="mt-4 text-xs bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/30 p-3 rounded-md text-amber-700 dark:text-amber-300 flex items-center">
                <svg 
                ...
                Vous pourrez modifier ce versement mensuel ultérieurement depuis votre espace personnel.
              </div>
            </div>
          </motion.div>
        )}
