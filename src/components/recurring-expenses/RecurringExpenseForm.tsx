...
export function RecurringExpenseForm({ expense, onSuccess, onCancel, colorPalette = "default" }: RecurringExpenseFormProps) {
  const { form, onSubmit } = useRecurringExpenseForm({ expense, onSuccess });
