...
export const MonthlyExpensesCard = ({
  ...
  return <motion.div initial={{
    ...
    y: -3
      ...
      <Card className={cn("backdrop-blur-sm cursor-pointer transition-all duration-300 h-full",
    ...
    "dark:bg-gradient-to-br dark:from-gray-900 dark:to-blue-950 dark:border-blue-900/30 dark:shadow-blue-800/30 dark:hover:shadow-blue-800/50")} onClick={() => navigate("/expenses")}>
