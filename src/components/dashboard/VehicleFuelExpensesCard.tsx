...
export const VehicleFuelExpensesCard = ({
  ...
  const tooltipContent = isPro && fuelVolume > 0 ? <div className="space-y-2 py-1">
  ...
  return <motion.div initial={{
    ...
    y: -3
      ...
      <Card className={cn("backdrop-blur-sm cursor-pointer transition-all duration-300 h-full relative overflow-hidden",
    ...
    "dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:border-gray-700/30 dark:shadow-gray-800/30 dark:hover:shadow-gray-800/50")} onClick={() => navigate("/vehicles")}>
        <CardHeader className="py-4">
          <div className="flex flex-row items-center justify-between">
            <CardTitle className="text-lg flex items-center gap-2">
              {/* Modification: afficher l'icône même sur mobile */}
              <div className={cn("p-2 rounded-full", "bg-gray-200 text-gray-600",
        ...
        <CardContent className="pb-4">
          <div className="space-y-4">
            ...
            stiffness: 100
              ...
              {isPro && tooltipContent ? <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <p className={cn("text-xl font-bold leading-none cursor-help", "text-gray-800", "dark:text-gray-100")}>
                ...
                </TooltipProvider> : <p className={cn("text-xl font-bold leading-none", "text-gray-800", "dark:text-gray-100")}>
                  {formatCurrency(totalFuelExpenses)}
                </p>}
