...
export const VehicleFuelExpensesCard = ({
  ...
  return <motion.div initial={{
    ...
    "dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 dark:border-gray-700/30 dark:shadow-gray-800/30 dark:hover:shadow-gray-800/50")} onClick={() => navigate("/vehicles")}>
        ...
        {!isPro && <div className="absolute inset-0 backdrop-blur-sm bg-white/50 dark:bg-black/60 z-10 flex flex-col items-center justify-center p-4 text-center">
        ...
        <CardContent className="pb-4">
          <div className="space-y-4">
            <motion.p className={cn("text-xl font-bold leading-none", "text-gray-800",
          // Light mode
