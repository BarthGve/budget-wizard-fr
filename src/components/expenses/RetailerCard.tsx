...
export function RetailerCard({ retailer, expenses, onExpenseUpdated, viewMode }: RetailerCardProps) {
  ...
  return (
    <>
      {/* Conteneur avec padding pour permettre l'élévation sans débordement */}
      <div className="pt-1 pb-3 px-1"> 
        <Card 
          className={cn(
            "overflow-hidden transition-all duration-200 h-full relative",
            "border bg-white border-gray-100",
            // Ombre légère par défaut, plus importante au survol
            "shadow-sm hover:shadow-md",
            // Translation au survol - l'animation est appliquée directement à la carte
            "hover:-translate-y-1",
            // Mode sombre
