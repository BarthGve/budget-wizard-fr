      ...
      <div className="grid gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
            ...
            <RecurringExpenseDialog trigger={<Button variant="outline" size="sm" className="ml-auto">
          ...
          <CardContent>
            <div className="space-y-4">
              {recurringExpenses?.map(expense => <div key={expense.id} className="flex items-center justify-between border-b pb-3">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex space-x-2">
                      <RecurringExpenseDialog expense={expense} trigger={<Button variant="ghost" size="sm">
                            <Edit2 className="h-4 w-4" />
                          </Button>} />
                      <Button variant="ghost" size="sm" onClick={() => handleDeleteExpense(expense.id)} className="text-indigo-600">
